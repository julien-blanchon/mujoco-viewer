<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-primary text-primary-foreground hover:bg-primary/85 border-primary/60 shadow-sm",
				outline: "border-border bg-input text-foreground hover:bg-accent hover:text-accent-foreground aria-expanded:bg-accent aria-expanded:text-accent-foreground",
				secondary: "bg-secondary text-secondary-foreground border-border hover:bg-accent hover:text-accent-foreground aria-expanded:bg-accent aria-expanded:text-accent-foreground",
